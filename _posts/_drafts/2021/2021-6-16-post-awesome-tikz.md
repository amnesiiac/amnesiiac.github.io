...
layout: post
title: "Awesome - tikz"
subtitle: 'latex tikz package相关资源整理'
author: "twistfatezz"
header-style: text
...
# Awesome Ti*k*Z
============
[Ti*k*Z](https://en.m.wikipedia.org/wiki/PGF/TikZ) is a wonderful awesome graph drawing package for TeX/LaTeX/ConTeXt. Unlike other TeX packages, TikZ itself is really huge, its manual contains about 1100+ pages, 100+ chapters. Tens of other packages, and serveral GUI applications are based on TikZ.<br>
...
## Libraries
From [CTAN](http://www.ctan.org/tex-archive/graphics/pgf/contrib/): <br>
...
-   [pgf-umlcd](http://www.ctan.org/tex-archive/graphics/pgf/contrib/pgf-umlcd) <font style="color:red; font-weight:bold"> - Some LATEX macros for UML Class Diagrams. </font>
...
## Reference
> https://github.com/xiaohanyu/awesome-tikz <br>
