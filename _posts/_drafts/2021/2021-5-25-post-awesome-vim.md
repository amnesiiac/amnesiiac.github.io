...
layout: post
title: "Awesome - Vim"
subtitle: 'vim command cheat sheet'
author: "twistfatezz"
header-style: text
...
// /[pattern]+<C-R>      从光标处向文件尾搜索pattern 并跳转
// ?[pattern]+<C-R>      从光标处向文件头搜索pattern 并跳转
...
**[frequently used]**
```c++
// v/character         选中当前字符到特定character的文本 -> 用于精细选择
// shift+v+/word       选中当前行到第一个含有word单词对应行的文本 -> 好用
// shift+v+20gg        选中当前行到20行的文本 -> 不如上面的好用
// shift+v+20j         选中当前行到下面20行之间的文本
// >                   增加缩进
// <                   减少缩进
// ~                   转换大小写
// d                   删除高亮选中的文字
...
```c++
// 1: ctrl+v 选中想要注释的多个行
//    (可以搭配652gg来选中到指定行or搭配/character选中到指定字符所在行)
// 2: 选中后按 I(大写) 进入编辑模式
// 3: 然后针对第一行输入 \\ 、# 、" 等注释符
// 4: Enter! 会发现所有选中的行已经注释好
```
#### Plugin Method - https://github.com/tpope/vim-commentary
```c++
// gcc                 注释当前行
...
// - 映射按键时，应该默认使用noremap，只有特别需要的时候使用map
// - 当你觉得做某事很低效时，你应该停下来，u u u u 然后思考正确的高效方式来完成
// - 用y复制文本后，命令模式中CTRL-R然后按双引号0可以插入之前复制内容
// - 某些情况下 Vim 绘制高亮慢，滚屏刷新慢可以试试 set re=1 使用老的正则引擎
// - Windows 下的 GVim 可以设置set rop=type:directx,renmode:5 增强显示
```
...
# Reference
> https://github.com/skywind3000/awesome-cheatsheets/blob/master/editors/vim.txt <br>
> https://github.com/groenewege/vimrc/blob/master/vim_cheat_sheet.txt <br>
> http://blog.g-design.net/post/4789778607/vim-cheat-sheet <br>
> http://www.keyxl.com/aaa8263/290/VIM-keyboard-shortcuts.htm <br>
> http://jmcpherson.org/editing.html <br>
> http://www.fprintf.net/vimCheatSheet.html <br>
> http://www.ouyaoxiazai.com/article/24/654.html <br>
> http://bbs.it-home.org/thread-80794-1-1.html <br>
> http://www.lpfrx.com/wp-content/uploads/2008/09/vi.jpg <br>
> http://michael.peopleofhonoronly.com/vim/ <br>
> https://github.com/hobbestigrou/vimtips-fortune/blob/master/fortunes/vimtips <br>
> https://github.com/glts/vim-cottidie/blob/master/autoload/cottidie/tips <br>
