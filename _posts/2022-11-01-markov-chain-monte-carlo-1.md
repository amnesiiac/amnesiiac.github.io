...
any two of markov chain state are connected: the possiblility start from arbitary state to any end state within limited steps is non-zero. hence, no isolated island of all possible states.
