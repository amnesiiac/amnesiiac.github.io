---
layout: post
title: "udrv: udrv_ll_init -> api control init (linux, udrv)"
author: "melon"
date: 1111-07-31 21:41
categories: "2024"
tags:
  - linux
  - driver
...
```blurtext
/* udrv/ll_services/udrv_ll_api_control_service.c */
static struct list enabled_api_list;

int udrv_ll_api_control_init(){
    list_init(&enabled_api_list);
    return 0;
}
```
